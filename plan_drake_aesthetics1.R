...
source(
  file.path(root(),"plan_drake_graphing_basics.R")
)
load_plan_drake_graphing_basics(ggline2Y3Y)
load_plan_drake_graphing_basics(subsetDataTWbank)
options(rstudio_drake_cache = storr::storr_rds("/mnt/e/githubdoc/Rstudio/109-1-econDV/.aesthetics1", hash_algorithm = "xxhash64"))
...
cache=drake::drake_cache(
  path="/mnt/e/githubdoc/Rstudio/109-1-econDV/.aesthetics1"),...)
}
...
drake::loadd(...,
cache=drake::drake_cache(
  path="/mnt/e/githubdoc/Rstudio/109-1-econDV/.aesthetics1"), envir = .GlobalEnv)
}
