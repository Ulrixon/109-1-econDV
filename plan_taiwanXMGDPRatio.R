...
chosenYear=2017
options(rstudio_drake_cache = storr::storr_rds("/home/ryan/Desktop/language/R/109-1-econDV/.taiwanXMGDPRatio", hash_algorithm = "xxhash64"))
...
cache=drake::drake_cache(
  path="/home/ryan/Desktop/language/R/109-1-econDV/.taiwanXMGDPRatio"))
}
